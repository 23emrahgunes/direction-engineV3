...
| V3.1 | Pending commit | Accepted: compileall; 68 pytest passed; ruff and mypy passed; diff check clean | Pending | 57 targeted domain/security tests; 68 full-suite tests | Local acceptance used Python 3.13.12; VPS Python 3.12.3 pending | 2026-09-15T10:35:34Z | Pending VPS |
