...
V3.11 contains the repository skeleton, fail-safe bootstrap configuration, immutable
...
reconciliation, and audit storage. No model is promoted without real historical evidence.
It contains no real order submission.
