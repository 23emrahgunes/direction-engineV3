...
V3.5 contains the repository skeleton, fail-safe bootstrap configuration, immutable
...
pricing simulation. It does not yet contain Directional Edge, Structural Arbitrage, or
