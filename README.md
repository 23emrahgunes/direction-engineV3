...
V3.6 contains the repository skeleton, fail-safe bootstrap configuration, immutable
...
pricing simulation. It also contains model-free Structural Arbitrage scanning and
deterministic PAPER/replay research. It does not yet contain Directional Edge or real
order submission.
