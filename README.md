...
V3.10 contains the repository skeleton, fail-safe bootstrap configuration, immutable
...
engine, and restart-safe strategy opportunity claims. No model is promoted without real
historical evidence. It contains no real order submission.
