...
V3.7 contains the repository skeleton, fail-safe bootstrap configuration, immutable
...
Directional Edge with fail-closed calibrated-model gates. It contains no real order
submission.
